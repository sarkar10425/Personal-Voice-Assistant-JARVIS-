# -*- coding: utf-8 -*-
"""
Created on Wed May 13 11:16:37 2020
...
def assistant(command):
    ...
    if 'open reddit' in command:
        ...
        engine.say('Bye bye Sir. Have a nice day!!')
    ...
    #open website
        ...
        if reg_ex:
            ...
            engine.say('The website you have requested has been opened for you Sir.')
    ...
    #greetings
        ...
        if day_time < 12:
            ...
            engine.say('Hello Sir. Good afternoon')
    ...
    #current weather
        ...
        if reg_ex:
            ...
            engine.say('Current weather in %s is %s. The maximum temperature is %0.2f and the minimum temperature is %0.2f degree celcius' % (city, k, x['temp_max'], x['temp_min']))
    ...
    #time
        ...
        engine.say('Current time is %d hours %d minutes' % (now.hour, now.minute))
    ...
    #email   
        ...
        if 'rajat' in recipient:
            ...
            engine.say('What should I say to him?')
            content = myCommand()
            ...
            engine.say('Email has been sent successfuly. You can check your inbox.')
    ...
    #launch any application
        ...
        engine.say('I have launched the desired application')
    ...
    #play youtube song
        ...
        engine.say('What song shall I play Sir?')
        ...
        if flag == 0:
            ...
            engine.say('I have not found anything in Youtube ')
...
sofiaResponse('Hi Arindam, I am Jarvis and I am your personal voice assistant, Please give a command or say "help me" and I will tell you what all I can do for you.')
engine.runAndWait()
while True:
    assistant(myCommand())    